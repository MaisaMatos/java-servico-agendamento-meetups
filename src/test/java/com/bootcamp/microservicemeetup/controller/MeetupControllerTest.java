...
public class MeetupControllerTest {
    ...
    public void createMeetupTest() throws Exception {
        ...
        // ao enviar uma req pra esse registration, precisa ser encontrado um valor que tem esse usuario
        ...
        // retorna o id do registro no meetup
    ...
    @Test
    @DisplayName("Should return error when try to register a meetup not existent")
    ...
    public void  meetupRegistrationErrorOnCreateMeetupTest() throws Exception {
        ...
        Registration registration = Registration.builder().id(11).name("Maisa Matos").registration("123").build();
        BDDMockito.given(registrationService.getRegistrationByRegistrationAttribute("123"))
                .willReturn(Optional.of(registration));
